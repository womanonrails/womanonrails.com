...
Można zarejestrować się na stronie [Mapbox](https://www.mapbox.com/) i skorzystać z ich darmowego pakietu do obsługi map lub użyć [OpenStreetMap](http://openstreetmap.org). Jest wiele serwisów, które dostarczają map tiles, na końcu tego artykułu postaram się wymienić kilka z nich.
