...
- {% include links/external-link.html
     name='RSpec'
     url='https://rspec.info/' %} - BDD tool for Ruby, but you can use it just for TDD
- {% include links/external-link.html
     name='Capybara'
     url='https://teamcapybara.github.io/capybara/' %} - Acceptance test framework for web applications
- {% include links/external-link.html
     name='Cucumber'
     url='https://cucumber.io/' %} - Tool for running automated tests written in plain language
...
- {% include links/external-link.html
     name='8 best Ruby on Rails refactoring talks'
